...
<xsl:stylesheet version="2.0" xmlns="http://www.loc.gov/mods/v3"
    ...
    <xd:doc>
        <xd:desc>
            <xd:p> The template to generate accessCondition uses xsl:analyze-string instruction to
                examine the content found within the &lt;cp:licenseLine> element at the displayLabel
                attribute</xd:p>
...
=                               <xsl:text>Creative Commons Attribution 4.0 Generic&#160;</xsl:text>
                        ...
                        <licence_ref>
                            <xsl:apply-templates select="doc:document/rdf:RDF/rdf:Description/oa:openAccessInformation/oa:userLicense"/>
                        </licence_ref>
                        <licence_ref>
